...
export const ICON_BY_KEY: Record<string, Component> = {
  home: House,
  house: House,
  дом: House,
  dom: House,
...
export const ICON_RULES: Array<{ re: RegExp; icon: Component }> = [
...
export const FALLBACK_ICONS: Record<
  "page" | "group" | "subgroup" | "itemLink" | "itemIframe" | "widget",
  Component
> = {
