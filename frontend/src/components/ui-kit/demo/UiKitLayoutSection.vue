<template>
  <section class="ui-kit-section">
    ...
    <article id="ui-node-toolbar" class="ui-kit-node">
      <h3>Toolbar</h3>
      <UiToolbar title="UI Primitive Demo" subtitle="Composable building blocks">
        <template #start>
    ...
    <div class="ui-kit-grid cols-2">
      <article id="ui-node-card" class="ui-kit-node">
        <h3>Card</h3>
        <UiCard title="Card Title" subtitle="Optional subtitle" footer="Card footer text">
          <p>
            Любой контент можно передать через slot: текст, формы, таблицы, графики.
          </p>
        </UiCard>
      </article>

      <article id="ui-node-divider" class="ui-kit-node ui-kit-stack">
        <h3>Divider</h3>
    ...
    <div class="ui-kit-grid cols-2">
      <article id="ui-node-fieldset-static" class="ui-kit-node">
      ...
      <article id="ui-node-fieldset-collapsible" class="ui-kit-node">
        <h3>Fieldset (collapsible)</h3>
        <UiFieldset v-model="fieldsetOpen" legend="Collapsible Fieldset" collapsible>
    ...
    <div class="ui-kit-grid cols-2">
      <article id="ui-node-accordion-vertical" class="ui-kit-node">
        <h3>Accordion (vertical)</h3>
        <UiAccordion :items="accordionItems" />
      </article>

      <article id="ui-node-accordion-horizontal" class="ui-kit-node">
    ...
    <div class="ui-kit-grid cols-2">
      <article id="ui-node-stepper" class="ui-kit-node">
        <h3>Stepper</h3>
        <UiStepper v-model="stepIndex" :steps="steps" />
      </article>

      <article id="ui-node-tabs" class="ui-kit-node">
        <h3>Tabs</h3>
