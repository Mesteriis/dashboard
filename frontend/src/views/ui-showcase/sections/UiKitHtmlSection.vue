  ...
  <section class="ui-kit-section ui-html">
    <div class="ui-kit-grid cols-2">
      <UiShowcaseNode
        ...
        element-label="HTML Typography & Semantics"
        :value="'semantic-tags'"
        :api="SHOWCASE_NODE_API['ui-node-html-tags']"
      >
      ...
      <UiShowcaseNode
        ...
        class="ui-html-card"
        group-label="Native HTML Catalog"
        element-label="HTML Lists & Table"
        :value="128"
        :api="SHOWCASE_NODE_API['ui-node-html-table-lists']"
      >
        <header class="ui-html-card__head">
    ...
    <div class="ui-kit-grid cols-2">
      <UiShowcaseNode
        ...
        class="ui-html-card"
        group-label="Native HTML Catalog"
        element-label="HTML Media & Embeds"
        :value="mediaState"
        :api="SHOWCASE_NODE_API['ui-node-html-media']"
      >
        <figure>
          <picture>
            <source
...
import UiKitHtmlFormCard from "@/views/ui-showcase/sections/UiKitHtmlFormCard.vue";
