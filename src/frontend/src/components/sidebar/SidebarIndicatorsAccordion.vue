      ...
      <div v-if="sidebarIndicators.length" class="sidebar-indicators">
        ...
        >
          ...
          <template v-else-if="widget.type === 'stat_card'">
            <p class="widget-value sidebar-indicator-value">
              {{ statCardValue(widget) }}
            </p>
          ...
          <template v-else-if="widget.type === 'stat_list'">
            <ul
              v-if="indicatorPreviewEntries(widget).length"
              class="widget-list sidebar-list-preview"
            >
              <li
                v-for="entry in indicatorPreviewEntries(widget)"
            ...
            <p class="sidebar-indicator-hint">
              Нажмите, чтобы открыть во вкладке
            </p>
          </template>
          ...
          <div
            v-if="widget.data.actions?.length || isLargeIndicator(widget)"
            class="widget-actions sidebar-indicator-actions"
          >
            <button
