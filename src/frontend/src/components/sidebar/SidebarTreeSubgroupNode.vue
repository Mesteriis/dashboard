<template>
  ...
  >
    ...
    <ul class="tree-items">
      <SidebarTreeItemNode v-for="item in subgroup.items" :key="item.id" :group="group" :subgroup="subgroup" :item="item" />
    </ul>
  </li>
</template>
...
import SidebarTreeItemNode from './SidebarTreeItemNode.vue'
