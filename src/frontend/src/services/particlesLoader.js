...
function hasParticlesJs() {
  return typeof /** @type {{ particlesJS?: unknown }} */ (window).particlesJS === 'function'
}
...
export async function ensureParticlesJs() {
  ...
  particlesScriptPromise = (async () => {
    ...
    let script = document.getElementById(PARTICLES_SCRIPT_ID) instanceof HTMLScriptElement
      ? /** @type {HTMLScriptElement} */ (document.getElementById(PARTICLES_SCRIPT_ID))
      : null
