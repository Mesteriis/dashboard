...
export function moveSubgroup(cfg, sourceGroupId, sourceSubgroupId, targetGroupId, targetSubgroupId) {
...
export function moveItemBefore(cfg, sourceGroupId, sourceSubgroupId, sourceItemId, targetGroupId, targetSubgroupId, targetItemId) {
...
export function moveItemToSubgroupEnd(cfg, sourceGroupId, sourceSubgroupId, sourceItemId, targetGroupId, targetSubgroupId) {
  const sourceSubgroup = findSubgroup(cfg, sourceGroupId, sourceSubgroupId)
  const targetSubgroup = findSubgroup(cfg, targetGroupId, targetSubgroupId)
  if (!sourceSubgroup || !targetSubgroup) return false
